...
const About = () => {
    return (
        <section id='About' className='px-10 py-10 w-full flex flex-col lg:flex-row  align-center bg-emerald-200 max-w-5xl mx-auto '>
            ...
            <div className='flex-1 flex flex-col justify-center items-start px-6 gap-5'>
                <div>
                    <h2 className='text-center text-emerald-500 text-5xl font-bold'>About Me:</h2>
                </div>
                <p>
